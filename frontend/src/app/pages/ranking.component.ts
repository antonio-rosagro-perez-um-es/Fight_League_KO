...
@Component({
  ...
  styles: [`
    ...
    .rank-row:hover { background: rgba(255,255,255,.07); border-color: rgba(32,217,100,.55); transform: translateX(4px); }
    .rank-row.podium { background: linear-gradient(90deg, rgba(124,255,159,.16), rgba(255,255,255,.04)); }
    .place { color: #7cff9f; font-weight: 900; }
    .avatar { color: #7cff9f; font-size: 2rem; }
